...
PLAYER_1_FILE = r"Oblig-3\files\yellow.png"
PLAYER_1_THRUST_FILE = r"Oblig-3\files\yellow_thrust.png"
PLAYER_2_FILE = r"Oblig-3\files\purple.png"
PLAYER_2_THRUST_FILE = r"Oblig-3\files\purple_thrust.png"
